...
var fourAdjacent = function() {
  ...
  // Start at 0,0 and check right 4, down 4, diagonal down left 4, and diagonal down right 4
  for (row; row < rows; row++) {
    for (col; col < cols; col++) {
      // Only check if there are at least 4 numbers left in row
      if (col <= cols - 4) {
        // Check right
